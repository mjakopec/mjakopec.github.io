export class Gauge extends HTMLElement {
	...
	get style() {
        ...
        :root {
          ...
          .slices .marker {
            ...
            animation: 0.5s ease-in 0s 1 gaugeRotation;
            transform: rotate(
          ...
          .needle {
            ...
            bottom: 0;
            left: 50%;
            height: calc(var(--gauge-height) * 0.9);
            width: 2px;
            box-shadow: 0 2px 2px 1px rgba(0, 0, 0, 0.38);
            background: #15222e;
            transform-origin: bottom;
            animation: 2.5s ease 0s 1 needleRotation;
          }
	...
	calculation() {
		this._trA =
			((this._trV - this._trMin) / (this._trMax - this._trMin)) * 180 -
			90;
	}
